...
function AccountItem({ account }) {
  ...
  return (
    <div class="loan-card" onMouseLeave={() => cancel()} onMouseEnter={() => { speakText(accountType + " " + "Account Number" + " " + accountNumber + " " + "is" + " " + status) }}>
      ...
      <div class="" style={{ display: "flex", justifyContent: "flex-end" }} >
        <Link to={"" + id}>
          <Button variant='contained' color="secondary" sx={{ fontSize: 12, color: colors.grey[250] }} size="medium" onMouseLeave={() => cancel()} onMouseEnter={() => { speakText("Press here to learn more") }}>Learn More</Button>
        </Link>
      </div>
    </div>
